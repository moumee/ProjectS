...
#include "SuraWeaponFullAutoFiringState.generated.h"
/**
 * 
 */
UCLASS()
class SURAS_API USuraWeaponFullAutoFiringState : public USuraWeaponBaseState
{
	GENERATED_BODY()
public:
	USuraWeaponFullAutoFiringState();
	~USuraWeaponFullAutoFiringState();
